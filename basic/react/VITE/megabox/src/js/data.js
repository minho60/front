...
export const datas = [
    ...
    },
    {
        ...
        like: 1300,
        description:
            " 2018년 10원 31일<br>시부야 역 주변에 갑자기 '장<br>막'이 내려지고, 다수의 일반인이<br> 갇히게 된다.<br>그곳에 홀로 뀌어든 현대최강의<br> 주술사, 고죠사토루.<br>그러나 그곳에는 고죠의 봉인을",
        score: 9
    },
    {
        rank: 3,
        ...
        like: 142,
        description:
            "   &quot;나 오늘 거기 탈고 옷 벗는다. &quot;<br><br>공들인 작전 실패로 강등당한후<br> 열정도, 의지도,수사감각도 모<br>두 잃은 형사 오남혁.<br>이제 그가 바라는 것은 오로지 한<br>탕과 은퇴뿐",
        score: 8.5
    },
    {
        rank: 4,
        ...
        like: 238,
        description:
              "세상의 부부들은 정말 밤마다 사<br>랑을 나눌까?<br>너희도 솔직해지고 싶지 않아?<br><br>불같던 결혼 생황은 사라지고 무<br>미건조한 일상만 남은 정아(공효<br>진)와 현수(김동욱).",
        score: 8.3
    }
];
